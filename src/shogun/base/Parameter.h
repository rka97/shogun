...
namespace shogun
{
	...
	public:
		...
		std::enable_if_t<
		    type_internal::is_sg_container<CT>::value &&
		    type_internal::is_sg_struct<ST>::value &&
		    (type_internal::is_sg_primitive<T>::value ||
		...
		add(CT<ST<T>>* param, const char* name, const char* description = "")
		{
			...
			EStructType stype = type_internal::sg_struct_type<ST>::stype;
			EContainerType ctype =
			    type_internal::sg_container_type<CT>::ctype;
		...
		std::enable_if_t<
		    type_internal::is_sg_primitive<T>::value ||
		        std::is_convertible<T, CSGObject*>::value,
		    void>
		add(T* param, const char* name, const char* description = "")
		{
			EPrimitiveType ptype = _get_ptype<T>();
