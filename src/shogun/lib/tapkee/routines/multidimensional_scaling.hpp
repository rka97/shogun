...
#pragma omp parallel shared(begin,landmarks,distance_matrix,callback)
	{
...
#pragma omp parallel shared(begin,end,to_process,distance_callback,landmarks, \
		landmarks_embedding,landmark_distances_squared,embedding)
	{
...
#pragma omp parallel shared(begin,distance_matrix,callback)
	{
		IndexType i_index_iter,j_index_iter;
#pragma omp for nowait
