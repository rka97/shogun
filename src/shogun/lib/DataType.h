...
namespace type_internal
{
	...
	template<>                                                          \
	struct sg_container_type<CT>                                                          \
	{                                                                          \
		static constexpr EContainerType ctype = type_;                                   \
	};																			\
    template<>                                                          \
	struct is_sg_container<CT> : public std::true_type                             \
	{                                                                          \
	};

	#define SG_ADD_STRUCT_TYPE(ST, type_)                                         \
	template<>                                                          \
	struct sg_struct_type<ST>                                                          \
	{                                                                          \
		static constexpr EStructType stype = type_;                                   \
	};																				\
	template<>                                                          \
	struct is_sg_struct<ST> : public std::true_type                             \
	{                                                                          \
	};
	...
	SG_ADD_STRUCT_TYPE(SGSparseMatrix, ST_SPARSE)
