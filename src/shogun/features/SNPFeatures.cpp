...
float64_t CSNPFeatures::dot(int32_t idx_a, CDotFeatures* df, int32_t idx_b) const
{
	...
	for (int32_t i = 0; i<alen-1; i+=2)
	{
		...
		else if (a1==a2 && b1==b2)
		{
			...
			{
				SG_ERROR("The impossible happened i={} a1=%c "
...
CSNPFeatures::dot(int32_t vec_idx1, const SGVector<float64_t>& vec2) const
{
	...
	for (int32_t i=0; i<len; i+=2)
	{
		...
		if (a1==a2 && a1!='0' && a2!='0')
		{
			...
			{
				SG_ERROR("The impossible happened i={} a1=%c a2=%c min=%c maj=%c\n",
	...
	for (int32_t i=0; i<num_str; i++)
	{
		...
		for (int32_t j=0; j<len; j+=2)
		{
			...
			if (a1==a2 && a1!='0' && a2!='0')
			{
				...
				{
					SG_ERROR("The impossible happened j={} a1=%c a2=%c min=%c maj=%c\n",
