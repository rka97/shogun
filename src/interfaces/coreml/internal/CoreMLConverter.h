...
#define REGISTER_COREML_CONVERTER3(factory, classname, machines) \
	REGISTER_COREML_CONVERTER4(factory, classname, machines, [](const CMachine* m) { return std::make_shared<classname>(m); })

#define REGISTER_CONVERTER(classname, __VA_ARGS__) \
